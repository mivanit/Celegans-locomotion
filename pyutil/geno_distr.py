...
dists_chemo_v1026D : ModParamsDists = {
	# chemo params
	ModParam("params", "ChemoReceptors.kappa") : NormalDistTuple(mu=230.0, sigma=100.0),
	ModParam("params", "ChemoReceptors.lambda") : NormalDistTuple(mu=-52000, sigma=20000.0),
	# conns
	ModParam("conn",   "Head,AWA,AIY,chem") : NormalDistTuple(mu=-10.0, sigma=10.0),
	ModParam("conn",   "Head,AIY,AIY,chem") : NormalDistTuple(mu=-1.0, sigma=1.5),
	ModParam("conn",   "Head,AIY,RIA,chem") : NormalDistTuple(mu=-40.0, sigma=40.0),
	ModParam("conn",   "Head,RIA,RMD*,chem") : NormalDistTuple(mu=-15.5, sigma=15.0),
	ModParam("conn",   "Head,SMD*,RIA,chem") : NormalDistTuple(mu=1.5, sigma=2.0),
	ModParam("conn",   "Head,RIA,RIA,chem") : NormalDistTuple(mu=0.0, sigma=0.1),
	ModParam("conn",   "Head,RIA,SMD*,chem") : NormalDistTuple(mu=10.0, sigma=20.0),
	ModParam("conn",   "Head,RMD*,RIA,chem") : NormalDistTuple(mu=0.0, sigma=1.0),
...
DEFAULT_DISTS : ModParamsDists = dists_chemo_v1026D
