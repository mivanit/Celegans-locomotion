...
MODPARAMS_DEFAULT_RANGES_CHEMO_V6 : ModParamsRanges = {
...
MODPARAMS_DEFAULT_RANGES_CHEMO_V7 : ModParamsRanges = {
	# conns
...
def run_genetic_algorithm(
		...
		ranges : ModParamsRanges = MODPARAMS_DEFAULT_RANGES_CHEMO_V7,
